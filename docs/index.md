# Bem-vindo ao projeto Sci-Find

O projeto sci-find consiste em um aplicativo que visa ampliar a produção, 
participação e o alcance de eventos e projetos de extensão acadêmica.

## Sobre a documentação

A documentação se divide em três tópicos principais:
